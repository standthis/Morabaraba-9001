...
namespace Morabaraba_9001
{
    public class Board : IBoard
    {
        ...
        public Board()
        {
            ...
            ITile A1 = AllTiles[('A', 1)] = new Tile(new List<(char, int)> { ('A', 4), ('B', 2), ('D', 1) });
            ITile A4 = AllTiles[('A', 4)] = new Tile(new List<(char, int)> { ('A', 1), ('A', 7), ('B', 4) });
            ITile A7 = AllTiles[('A', 7)] = new Tile(new List<(char, int)> { ('A', 4), ('B', 6), ('D', 7) });

            ITile B2 = AllTiles[('B', 2)] = new Tile(new List<(char, int)> { ('A', 1), ('B', 4), ('C', 3), ('D', 2) });
            ITile B4 = AllTiles[('B', 4)] = new Tile(new List<(char, int)> { ('A', 4), ('B', 2), ('B', 6), ('C', 4) });
            ITile B6 = AllTiles[('B', 6)] = new Tile(new List<(char, int)> { ('A', 7), ('B', 4), ('D', 6), ('C', 5) });

            ITile C3 = AllTiles[('C', 3)] = new Tile(new List<(char, int)> { ('B', 2), ('C', 4), ('D', 3) });
            ITile C4 = AllTiles[('C', 4)] = new Tile(new List<(char, int)> { ('B', 4), ('C', 3), ('C', 5) });
            ITile C5 = AllTiles[('C', 5)] = new Tile(new List<(char, int)> { ('B', 6), ('C', 4), ('D', 5) });

            ITile D1 = AllTiles[('D', 1)] = new Tile(new List<(char, int)> { ('A', 1), ('D', 2), ('G', 1) });
            ITile D2 = AllTiles[('D', 2)] = new Tile(new List<(char, int)> { ('B', 2), ('D', 1), ('D', 3), ('F', 2) });
            ITile D3 = AllTiles[('D', 3)] = new Tile(new List<(char, int)> { ('C', 3), ('D', 2), ('E', 3) });

            ITile D5 = AllTiles[('D', 5)] = new Tile(new List<(char, int)> { ('C', 5), ('D', 6), ('E', 5) });
            ITile D6 = AllTiles[('D', 6)] = new Tile(new List<(char, int)> { ('B', 6), ('D', 5), ('D', 7), ('F', 6) });
            ITile D7 = AllTiles[('D', 7)] = new Tile(new List<(char, int)> { ('A', 7), ('D', 6), ('G', 7) });

            ITile E3 = AllTiles[('E', 3)] = new Tile(new List<(char, int)> { ('A', 7), ('D', 6), ('G', 7) });
            ITile E4 = AllTiles[('E', 4)] = new Tile(new List<(char, int)> { ('E', 3), ('F', 4), ('E', 5) });
            ITile E5 = AllTiles[('E', 5)] = new Tile(new List<(char, int)> { ('D', 5), ('E', 4), ('F', 6) });

            ITile F2 = AllTiles[('F', 2)] = new Tile(new List<(char, int)> { ('D', 2), ('E', 3), ('F', 4), ('G', 1) });
            ITile F4 = AllTiles[('F', 4)] = new Tile(new List<(char, int)> { ('E', 4), ('F', 2), ('F', 6), ('G', 4) });
            ITile F6 = AllTiles[('F', 6)] = new Tile(new List<(char, int)> { ('D', 6), ('E', 5), ('F', 4), ('G', 7) });

            ITile G1 = AllTiles[('G', 1)] = new Tile(new List<(char, int)> { ('D', 1), ('F', 2), ('G', 4) });
            ITile G4 = AllTiles[('G', 4)] = new Tile(new List<(char, int)> { ('F', 4), ('G', 1), ('G', 7) });
            ITile G7 = AllTiles[('G', 7)] = new Tile(new List<(char, int)> { ('D', 7), ('F', 6), ('G', 4) });
        ...
        public IEnumerable<ITile> Cows(Color c)
        {
            ...
            yield return new Tile(new List<(char, int)> { ('D', 7), ('F', 6), ('G', 4) });
